...
<form action="birth.php" method="POST" class="form">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">Enter your birthday:</label>
    <input class="input"  type="date" class="form-control" id="exampleInputPassword1" name="prenom" >
  </div>
...
<?php
	if (isset($_POST['button'])) {
		...
		<?php }
			...
			$a="UPDATE user SET date_de_naissance='$date' WHERE email='$mail'; " ;
